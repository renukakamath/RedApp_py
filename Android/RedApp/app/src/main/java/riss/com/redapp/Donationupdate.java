...
public class Donationupdate extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donationupdate);
        ...
        JR.json_response = (JsonResponse) Donationupdate.this;
        String q = "/dviewusers?lid="+sh.getString("log_id", "");
        q = q.replace(" ", "%20");
        JR.execute(q);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JsonReq JR = new JsonReq(getApplicationContext());
                JR.json_response=(JsonResponse) Donationupdate.this;
                String q = "/dupdateuser?login_id="+sh.getString("log_id", "")+"&name="+name+"&place="+place+"&Phone="+phone+ "&email="+email +"&age="+age;
                q=q.replace(" ","%20");
                JR.execute(q);
            }
        });
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if(method.equalsIgnoreCase("dviewusers")) {
            ...
            else if(method.equalsIgnoreCase("dupdateuser"))
            {
                try {
                    String status=jo.getString("status");
                    Log.d("pearl",status);
