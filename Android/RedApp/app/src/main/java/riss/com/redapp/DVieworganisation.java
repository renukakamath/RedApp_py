...
public class DVieworganisation extends AppCompatActivity implements JsonResponse {
    ListView l1;
...
//        l1.setOnItemClickListener(this);
        ...
        JR.json_response = (JsonResponse) DVieworganisation.this;
        String q = "/Vieworganisation?login_id=" +sh.getString("login_id", "")+"&oid="+DViewCamps.oid;
        JR.execute(q);
    }
