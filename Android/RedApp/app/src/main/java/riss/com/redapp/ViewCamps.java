...
public class ViewCamps extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response = (JsonResponse) ViewCamps.this;
        String q = "/view_camps/";
        JR.execute(q);
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ViewCamps.this);
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("Map")) {
                    ...
                    startActivity(new Intent(getApplicationContext(),Vieworganisation.class));


                }

                else if (items[item].equals("View  Blood details")) {
                    startActivity(new Intent(getApplicationContext(),AvailableBloods.class));
