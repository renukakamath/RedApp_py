...
public class DViewdonations extends AppCompatActivity implements JsonResponse {
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response = (JsonResponse) DViewdonations.this;
        String q = "/Viewdonations?log_id=" +sh.getString("login_id", "");
        JR.execute(q);
    }
