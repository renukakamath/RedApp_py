...
public class AvailableBloods extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response = (JsonResponse) AvailableBloods.this;
        String q = "/available_bloods?&oid="+ViewCamps.gid;
        JR.execute(q);
    }
